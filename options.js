...
document.getElementById('babis_switch').addEventListener('click', vodkadsi_save_options);
document.getElementById('dezin_switch').addEventListener('click', vodkadsi_save_options);
document.getElementById('border_switch').addEventListener('click', vodkadsi_save_options);
